    ...
    >
      ...
      <div
        style={{
          ...
          width: '480px',
          height: '480px',
          background: 'radial-gradient(circle, rgba(227,194,74,0.12) 0%, transparent 70%)',
          pointerEvents: 'none',
          borderRadius: '50%',
          filter: 'blur(40px)',
          zIndex: 0,
      ...
      <div
        style={{
          ...
          width: '620px',
          height: '620px',
          background: 'radial-gradient(circle, rgba(227,194,74,0.12) 0%, transparent 65%)',
          pointerEvents: 'none',
          borderRadius: '50%',
          filter: 'blur(30px)',
          zIndex: 0,
        ...
        >
          ...
          <div
            style={{
              ...
              background: 'rgba(0,0,0,0.55)',
              border: `1px solid ${muted ? 'rgba(255,255,255,0.08)' : 'rgba(227,194,74,0.3)'}`,
              borderRadius: '50%',
